...
def create_nobilia_shelf(km, prefix, origin_pose=gm.eye(4), parent_path=Path('world')):
    ...
    geom_panel_top = Box(l_prefix + ('panel_top',), gm.eye(4), 
                                                    gm.vector3(shelf_height * 0.5 - 0.005, 
                                                               shelf_width - 0.005,
                                                               wall_width))
    ...
    top_hinge_in_body_marker           = gm.translation3(0.08762252, 0, -0.01433833)
    top_panel_marker_in_top_hinge      = gm.translation3(0.2858676, 0, 0.00871125)
    front_hinge_in_top_panel_maker     = gm.translation3(0.1072496, 0, -0.01232362)
